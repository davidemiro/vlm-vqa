...
class VLMConfig(PretrainedConfig):
    def __init__(self, text_length=32, num_patches=64, visual_embed_dim=768, torch_dtype=torch.float16, **kwargs):
        ...
        self.lm_config.context_length = self.lm_config.text_length + self.vit_config.num_patches
        self.lm_config.torch_dtype = torch_dtype
